...
public class ViewDB extends Activity implements OnItemClickListener
{
	...
	ListView list;
	Context context;
	final static String[] arrayColumns = new String[]{dBase.COLUMN_NAME_FROMSYMBOL,dBase.COLUMN_NAME_TOSYMBOL,dBase.COLUMN_NAME_MULTIBY};
	final static int[] arrayViewIDs = new int[]{R.id.tvListFrom,R.id.tvListTo,R.id.tvListMultiplyBy};
	@Override
